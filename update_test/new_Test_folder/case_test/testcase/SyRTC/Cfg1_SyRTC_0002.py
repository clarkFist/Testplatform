...
def step2():
    LogPath_set('02')
    sims = Simulator('cfg1')
    sims.openwith(1, 'AAAAAAAAAAAA8')
    mvcu = form.get_active_mvcu()
    form.tst_set(mvcu, Tag.tag_send('000201' + '11'))
    form.tst_set('3', Tag.tag_send('000201' + '11'))
    sleep(120)
...
def step3():
    ...
    sims = Simulator('cfg1')
    sims.close(1)
    sims.openwith(4, '0' * 32 + '2AAAAAAAAAAAA')
    form.tst_set('14', Tag.tag_send('000201' + '11'))
    sleep(20)
