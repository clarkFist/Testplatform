...
def before_main():
    LogPath_set('default')
'''''''''''' # 以上为固定头
requirement = caseFunc.StubRequirement(slots='5') #slots='2,3-8'  # 当前用例的环境需求 ，该变量必须赋值

   
def step2():
    dst_slot = '5'
    LogPath_set('02')
    form.tst_set(dst_slot, Tag.tag_send('00510111'))
    time.sleep(60)
...
def step3():
    dst_slot = '5'
    LogPath_set('03')
    form.tst_set(dst_slot, Tag.tag_send('00510311'))
    time.sleep(60)
...
def step4():
    dst_slot = '5'
    LogPath_set('04')
    form.tst_set(dst_slot, Tag.tag_send('00510211'))
    form.tst_set(dst_slot, Tag.tag_send('00510311'))
    time.sleep(60)
