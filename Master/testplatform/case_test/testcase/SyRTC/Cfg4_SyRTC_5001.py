...
def step2():
    form.tst_set('3-8', Tag.tag_send('00610111'))
    sims = Simulator('cfg4')
    for i in range(1, 7):
        sims.openwith(i, 'E')
    time.sleep(60)
...
def step3():
    form.tst_set('2.16', Tag.tag_send('50010111'))
    Log.show_flag = False
    caseFunc.wait_to_ack_ext('Unplug the MVCU-S red and blue network')
    print('ok')
    time.sleep(30)

def step4():
    #form.tst_set('2.16', Tag.tag_send('50010211'))
    caseFunc.wait_to_ack_ext('plug the MVCU-S red and blue network')
    print('ok')
    time.sleep(30)
...
def step5():
    form.tst_set('2.16', Tag.tag_send('50010211'))
    Log.show_flag = False
    caseFunc.wait_to_ack_ext('Unplug the MVCU-P red and blue network')
    print('ok')
    time.sleep(30)
