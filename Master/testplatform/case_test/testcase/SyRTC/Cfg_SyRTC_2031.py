...
def step2(count): 
    ...
    form.tst_set(2, Tag.tag_send('20310111')) 
    form.tst_set(16, Tag.tag_send('20310111')) 
    sleep(100)

    form.tst_set(2, Tag.tag_send('20310100')) 
    form.tst_set(16, Tag.tag_send('20310100')) 
def main():    
    for count in range(1, 6):
        caseFunc.wait_to_ack_ext("plug out SVCU, open 2031_1 in SVCU init ", timeout=200)
        Log.show_flag = True 
        step2(count)
