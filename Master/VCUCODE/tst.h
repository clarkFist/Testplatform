...
#define ReprogBreakOnDump 110 //若定义该宏则允许在上电180s 前宕机重启后进Reprog
...
typedef struct{
	...
	INT8U srcNodeID;
	INT8U dataType;//
	INT8U dataLen; // 包括dstNodeID  srcNodeID dataType 的长度
...
#define Tst_F_canAddrGet(id)	(0x7f000000u|id|(GUEST_C_HIGH_PRIO<<16))
