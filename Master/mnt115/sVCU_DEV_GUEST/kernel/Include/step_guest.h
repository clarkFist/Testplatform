 ...
 *     In case of using an applicative key pbForceBid shall be TRUE and pBidValue shall be forced to 0x03 on
 *     CPU_A and 0x43 on CPU_B
...
/*20210302,Add maintenance information,CR:2623*/
/**
 ******************************************************************************
 * \par Description:
