...
def step2():
    ...
    form.tst_set(dst_slot, Tag.tag_send('50270111'))
    time.sleep(10) 

def step3():
    LogPath_set('03')
    form.tst_set(dst_slot, Tag.tag_send('50270311'))
    time.sleep(2) 
    form.tst_set(dst_slot, Tag.tag_send('50270300'))
    time.sleep(20) 

def step4():
    LogPath_set('04')
    form.tst_set(dst_slot, Tag.tag_send('50270211'))
    time.sleep(20) 
