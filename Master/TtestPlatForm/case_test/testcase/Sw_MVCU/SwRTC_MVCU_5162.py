...
def step2():
    LogPath_set('02')
    form.tst_set(2, Tag.tag_send('51620111'))
    form.tst_set(16, Tag.tag_send('51620111'))
    time.sleep(1)
    form.tst_set(2, Tag.tag_send('51620100'))
    form.tst_set(16, Tag.tag_send('51620100'))
    time.sleep(20)

def step3():  #2023/5/23目前自动更新没有调好，需要手动远程更新，注意打开CRT保持记录
    LogPath_set('03')
    caseFunc.vm_build_update('2', 'VCU_MVCU_SwRTC_5162003') #初始化开桩
    time.sleep(20)
