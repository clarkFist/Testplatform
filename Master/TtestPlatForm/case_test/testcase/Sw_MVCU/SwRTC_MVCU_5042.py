...
def step2(): 
    LogPath_set('02')
    form.tst_set(dst_slot, Tag.tag_send('50420111'))
    time.sleep(2)
    form.tst_set(dst_slot, Tag.tag_send('50420100'))
    time.sleep(20)
   
def step3():
    LogPath_set('03')
    form.tst_set(dst_slot, Tag.tag_send('50420211'))
    time.sleep(2)
    form.tst_set(dst_slot, Tag.tag_send('50420200'))
    time.sleep(10)

def step4():
    LogPath_set('04')
    form.tst_set(dst_slot, Tag.tag_send('50420311'))
    time.sleep(10) 
