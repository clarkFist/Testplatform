...
def plugout():
    Log.show_flag = False
    form.before_dump('2')
    caseFunc.wait_to_ack_ext("plug out MVCU", timeout=200)
    Log.show_flag = True
    time.sleep(10)

def step2():
    LogPath_set('02')
    form.tst_set(svcu, Tag.tag_send('20390111'))
    time.sleep(10)
    form.tst_set(svcu, Tag.tag_send('20390100'))
def step3():
    LogPath_set('03')
    form.tst_set(svcu, Tag.tag_send('20390211'))
    plugout()
    time.sleep(20)
def main():
