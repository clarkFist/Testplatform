...
def step2():
    LogPath_set('02')
    form.tst_set(svcu, Tag.tag_send('11070111'))
    time.sleep(700)

def step3():
    LogPath_set('03')
    form.tst_set(svcu, Tag.tag_send('11070211'))
    time.sleep(700)
    FuncMode = form.get_funcMode(svcu)
    print("FuncMode %d\n",FuncMode)
...
def step4():
    ...
    #form.update('auto', 0 , svcu) #为了恢复熔丝
    form.tst_set(svcu, Tag.tag_send('11070311'))
    time.sleep(700)
