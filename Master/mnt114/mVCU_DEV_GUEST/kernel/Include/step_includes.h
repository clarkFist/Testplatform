 ...
 * FILES TO INCLUDE
 *****************************************************************************/
 /*20201225, coverity test, CR:2510*/
#include "datatypes.h"
...
/*20190718, add functions for controlling EXT LED and ETH LED, CR:1631*/

typedef struct
{
    MSTEPINC_E_GpioId canLed; /**<Id of the GPIO associated with CAN */
    MSTEPINC_E_GpioId masterLed; /**<Id of the GPIO associated with master */
    MSTEPINC_E_GpioId ethLed1; /**<Id of the GPIO associated with Ethernet1 */
    MSTEPINC_E_GpioId ethLed2; /**<Id of the GPIO associated with Ethernet2 */
...
/*20190718, add four network port function and add new protocol RSSP1, CR:1630*/
/*20210803,Update userdata struct in forcce key mode, CR:2917*/
#pragma pack(1)
typedef struct
{
    INT32U ipNormal_1;                                                                   /**< IP address of communication on PRIMARY NORMAL ethernet */
    INT32U ipNormal_2;																	 /**< IP address of communication on SECONDARY NORMAL ethernet*/
    INT32U ipRedundant_1;                                                                /**< IP address of communication on PRIMARY REDUNDANT ethernet*/
	INT32U ipRedundant_2;																 /**< IP address of communication on SECONDARY REDUNDANT ethernet*/
	INT32U NonSafetyIp_1;																 /**< IP address of communication on NONSAFETY NORMAL ethernet*/
	INT32U NonSafetyIp_2;																 /**< IP address of communication on NONSAFETY REDUNDANT ethernet*/
    INT32U subnetMaskNormal_1;                                                           /**< For ethernet communication (PRIMARY NORMAL) */
	INT32U subnetMaskNormal_2;															 /**< For ethernet communication (SECONDARY NORMAL) */
    INT32U subnetMaskRedundant_1;                                                        /**< For ethernet communication (PRIMARY REDUNDANT) */
	INT32U subnetMaskRedundant_2;														 /**< For ethernet communication (SECONDARY REDUNDANT) */
	INT32U subnetMaskNonSafety_1;														 /**< For ethernet communication (NONSAFETY NORMAL) */
	INT32U subnetMaskNonSafety_2;														 /**< For ethernet communication (NONSAFETY REDUNDANT) */
    INT32U gtwAdressNormal_1;                                                            /**< Gateway address (PRIMARY NORMAL) */
	INT32U gtwAdressNormal_2;															 /**< Gateway address (SECONDARY NORMAL) */
    INT32U gtwAdressRedundant_1;                                                         /**< Gateway address (PRIMARY REDUNDANT) */
	INT32U gtwAdressRedundant_2;														 /**< Gateway address (SECONDARY REDUNDANT) */
	INT32U gtwAdressNonSafety_1;														 /**< Gateway address (NONSAFETY NORMAL) */
	INT32U gtwAdressNonSafety_2;														 /**< Gateway address (NONSAFETY REDUNDANT) */
