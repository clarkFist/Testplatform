...
/*20200422, Add the function of mode switch by application request, CR:2080*/
#define EVT_C_SWITCH_TO_SDANDBY              (GDF_T_EventId)75u  /**<mode switch to sdandby*/
#define EVT_C_CAN_BREAK_SWITCH               (GDF_T_EventId)76u  /**<bus switch medium type 1*/
#define EVT_C_CAN_BUSOFF_SWITCH              (GDF_T_EventId)77u  /**<bus switch busoff type*/
#define EVT_C_CAN_MODULE_SWITCH              (GDF_T_EventId)78u  /**<bus switch module type*/
#define EVT_C_EXTERNAL_UPDATE                (GDF_T_EventId)79u  /**< External update ok */
...
#define EVT_C_NBDEFAUT                       (GDF_T_EventId)80u  /**< BE CAREFUL, this ID shall be <= 191 */
/******************************************************************************
