...
/* 定义GM_MQ_FIXED中消息队列最多存放的消息数 */
#define GM_MQ_FIXED_MSG_SIZE	500U
...
/************  用户定义区10， GAPP,RMS,RMS_UDP中的应用选择 *********/
/* 定义GAPP,RMS,RMS_UDP中动态添加节点最大数目 */
#define GM_NODE_ADD_MAX_NUM (10U) /* add by Xavier 13-08-07 动态添加节点最大数目，限制为255 */
/*定义动态添加节点消息类型AppType*/
#define GM_GAPP_APP_TYPE_DYN  (10U)
...
/*RSSP1 Macro definition*/
#define SFM_Part
#define CFM_Part
#define LINK_Part
//#define GM_RSSP1_ENABLE_CRSCD_PACK
