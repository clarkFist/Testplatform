...
extern "C"
{
    ...
    */
    ...
    typedef struct
    {
        ...
        GM_RSSP1_UINT32                      head_Position;  /**< 头指针 */
        GM_RSSP1_UINT32                      tail_Position;  /**< 尾指针 */
        GM_RSSP1_UINT32                      count;          /**< 当前队列中已有的元素个数 */

        GM_RSSP1_UINT32                      Q_size;         /**< 队列总容量 */
        GM_RSSP1_UINT32                      Q_offset;       /**< 队列头地址偏移量 */
		GM_RSSP1_MUTEX                 mutex;
    } GM_RSSP1_PACKED GM_RSSP1_Msg_Queue_struct;
    ...
    * @return GM_RSSP1_BOOL  成功返回GM_RSSP1_TRUE;如果队列已空, 则返回FALSEA
    */
    ...
    * 删除队头的元素, 队列长度-1.
    * @param[in/out] pQueuestruct 队列结构体指针
    * @return GM_RSSP1_BOOL  成功返回GM_RSSP1_TRUE;队列已空, 返回FALSEA
    */
